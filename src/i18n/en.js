export const en = {
  ...
  streamer: {
    ...
    step3: "3. Set resolution to <strong id=\"obs-step3-size\">{size}</strong> and click OK.",
  ...
  webWidget: {
    btnLabel: "Website Widget",
    title: "Embed Widget on Website",
    subtitle: "HTML code generator for embedding season countdowns and status cards on your site",
    gameLabel: "GAME",
    allGames: "All Games",
    typeLabel: "WIDGET TYPE",
    typeStatus: "Season Status",
    typeCountdown: "Countdown Timer",
    typeCard: "Full Season Card",
    themeLabel: "COLOR THEME",
    themeDark: "Dark",
    themeLight: "Light",
    themeTransparent: "Transparent",
    dimensionsLabel: "DIMENSIONS (WIDTH × HEIGHT)",
    codeLabel: "HTML EMBED CODE (IFRAME)",
    btnCopyCode: "Copy HTML Code",
    copied: "Copied!",
    previewTitle: "Live Interactive Preview",
    brandingNotice: "Widget includes logo and link to SeasonForge."
  }
};
